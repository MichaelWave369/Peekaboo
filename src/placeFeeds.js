...
export const PLACE_FEEDS = [
  ...
  {
    id: 'yosemite-nps-webcams',
    name: 'Yosemite National Park Webcams',
    ...
    summary: 'Official NPS Yosemite webcam hub covering high-country, air-quality, ski-area and river-condition views, with some cameras operated by park partners.',
    media: 'mixed',
    externalOnly: true,
  },
  {
    id: 'zion-nps-webcam',
    name: 'Zion — Temples and Towers of the Virgin',
    ...
    lat: 37.2009,
    lon: -112.9870,
    url: 'https://www.nps.gov/zion/learn/photosmultimedia/webcams.htm',
    summary: 'Official Zion National Park webcam at park headquarters looking toward the Temples and Towers of the Virgin.',
    media: 'snapshot',
    externalOnly: true,
  },
  {
    id: 'mount-rainier-nps-webcams',
    name: 'Mount Rainier National Park Webcams',
    ...
    summary: 'Official NPS Mount Rainier webcam hub with Longmire, Paradise, Sunrise, mountain, parking and air-quality views. Some cameras are seasonal.',
    media: 'mixed',
    externalOnly: true,
  },
  {
    id: 'glacier-nps-webcams',
    name: 'Glacier National Park Webcams',
    ...
    summary: 'Official Glacier National Park webcam hub with Lake McDonald, Apgar, Logan Pass, Many Glacier, St. Mary, Two Medicine and night-sky views.',
    media: 'mixed',
    externalOnly: true,
  },
  {
    id: 'great-smokies-nps-webcams',
    name: 'Great Smoky Mountains Webcams',
    ...
    summary: 'Official NPS Great Smoky Mountains webcam hub. NPS describes the current digital views as updating approximately every 15 minutes.',
    media: 'snapshot',
    externalOnly: true,
  },
  {
    id: 'acadia-nps-webcams',
    name: 'Acadia National Park Webcams',
    ...
    summary: 'Official NPS Acadia webcam page with Jordan Pond and air-quality views plus partner-hosted regional cameras.',
    media: 'mixed',
    externalOnly: true,
  },
  {
